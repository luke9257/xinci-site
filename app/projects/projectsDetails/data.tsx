...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: (
      <div>
        <p style={{ color: '#4e5461' }}>品牌升级焕新是围绕经典产品、系列作的整合营销战役，我们通过关键节点和圈层突破策略，提升品牌价值感知、强化用户情感连接，驱动用户增长与品牌忠诚度提升，助您实现长效业绩增长。</p>
        <h3>品牌形象升级</h3>
        <p style={{ color: '#4e5461' }}>通过视觉体系升级和价值主张刷新，建立差异化品牌形象。</p>
        <ul>
          <li style={{ color: '#4e5461' }}><strong>1. 视觉系统升级：</strong>重新设计Logo、字体等，打造具有辨识度的品牌形象。</li>
          <li style={{ color: '#4e5461' }}><strong>2. 价值主张重构：</strong>梳理并重新定义品牌核心价值，明确定位和差异化优势。</li>
          <li style={{ color: '#4e5461' }}><strong>3. 品牌个性定义：</strong>基于产品故事和目标用户特征，确立品牌个性和沟通风格。</li>
          <li style={{ color: '#4e5461' }}><strong>4. 品牌资产建设：</strong>构建完整的品牌资产库，确保各触点形象一致性。</li>
        </ul>
        <h3>用户认知焕新</h3>
        <p style={{ color: '#4e5461' }}>通过圈层运营和用户情感连接，提升品牌忠诚度和用户LTV。</p>
        <ul>
          <li style={{ color: '#4e5461' }}><strong>1. 关键节点营销：</strong>针对产品发布、重要更新等节点，进行精准营销投放。</li>
          <li style={{ color: '#4e5461' }}><strong>2. 核心圈层运营：</strong>深度运营KOL、KOC、创作者等关键圈层，放大品牌传播效果。</li>
          <li style={{ color: '#4e5461' }}><strong>3. 情感连接构建：</strong>通过内容营销、互动体验、用户共创强化用户情感连接。</li>
          <li style={{ color: '#4e5461' }}><strong>4. 长效增长机制：</strong>优化产品体验优化和价值传播机制，实现持续业绩增长。</li>
        </ul>
      </div>
    ),
