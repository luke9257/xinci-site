...
export const projects: Project[] = [
  {
    id: 'nova-finance',
    title: '新品上市策略', // 修改：更新标题
    category: '策略与规划', // 修改：更新分类
    description: (
      <div>
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <ul>
          <li style={{ color: '#4e5461' }}><strong>1. 视觉系统升级：</strong> 重新设计Logo、色彩、字体等，打造具有辨识度的品牌形象。</li>
          <li style={{ color: '#4e5461' }}><strong>2. 价值主张重构：</strong> 梳理并重新定义品牌核心价值，明确定位和差异化优势。</li>
          <li style={{ color: '#4e5461' }}><strong>3. 品牌个性定义：</strong> 基于IP世界观和目标用户特征，确立品牌个性和沟通风格。</li>
          <li style={{ color: '#4e5461' }}><strong>4. 品牌资产建设：</strong> 构建完整的品牌资产库，确保各触点形象一致性。</li>
        </ul>
        
        <h3>用户认知焕新</h3>
        <p style={{ color: '#4e5461' }}>通过深度圈层运营和情感连接构建，提升品牌忠诚度和用户LTV。</p>
        <ul>
          <li style={{ color: '#4e5461' }}><strong>1. 核心圈层运营：</strong> 深度运营KOL、KOC等关键圈层，放大品牌传播效果。</li>
  ...
  {
    id: 'artisan-cafe',
    title: '创意服务', // 修改：从"内容与创意"改为"创意服务"
    category: '内容与创意', // 修改：从"创意服务"改为"内容与创意"
    description: (
      <div>
  ...
  {
    id: 'nomad-travel',
    title: '内容营销', // 修改：从"内容与创意"改为"内容营销"
    category: '内容与创意', // 修改：从"内容营销"改为"内容与创意"
    description: (
      <div>
  ...
  {
    id: 'tech-summit-2024',
    title: '社媒运营', // 修改：从"社媒与社群"改为"社媒运营"
    category: '社媒与社群', // 修改：从"社媒运营"改为"社媒与社群"
    description: (
      <div>
